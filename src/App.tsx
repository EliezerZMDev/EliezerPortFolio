...
export default function FuturisticPortfolio() {
  ...
  const PROFILE = {
    ...
    links: {
      ...
      cv: "EliezerPortFolio/CV.pdf" // coloca tu archivo en /public
    }
  };
  ...
  const PROJECTS = [
    {
      ...
      image: "EliezerPortFolio/proyectos/BlogLiveLogo1.png" // captura de pantalla del proyecto
    },
    {
      ...
      repo: "",
      status: "en curso",
      image: "EliezerPortFolio/proyectos/Portfolio.png" // captura de pantalla del proyecto
    },
    {
      ...
      repo: "",
      status: "en curso",
      image: "EliezerPortFolio/proyectos/Syncboard.png" // captura de pantalla del proyecto
    }
  ];
